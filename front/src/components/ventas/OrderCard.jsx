...
export const OrderCard = ({ order, admin = false }) => {
    ...
    const redirectLink = admin ? `/admin/venta/${encodeURIComponent(encryptedId)}`: `/my-order/${encodeURIComponent(encryptedId)}`;
            ...
            <div className="flex flex-col py-1 px-2">
                {
                    ...
                    <div className="flex items-end gap-2">
                        <p title={order.cliente} className="text-lg font-bold italic truncate">{order.cliente}</p>
                    </div>
                }
                <div className="flex items-end gap-2">
