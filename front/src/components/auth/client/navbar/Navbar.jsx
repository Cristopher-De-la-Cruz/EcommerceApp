...
import { faBars, faCartShopping, faBox } from "@fortawesome/free-solid-svg-icons"
import { NavUser } from "./NavUser"

export const Navbar = () => {
    return (
        <div className="duration-400 w-full h-16 bg-red-800 flex justify-between items-center">
            {/* Left */}
            <div className="duration-400 sm:w-2/5 w-5/5 h-full flex items-center gap-5">
                <div className="w-16 flex justify-end items-center">
                    <button className="border-2 text-white rounded-md w-10 h-10 flex text-xl justify-center items-center cursor-pointer">
